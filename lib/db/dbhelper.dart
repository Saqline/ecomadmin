...
class DbHelper {
 ...
 static Future<void> addNewPurchase(PurchaseModel purchaseModel, CategoryModel catModel, num newStock) {
    final wb = _db.batch();
  ...
  static Stream<DocumentSnapshot<Map<String, dynamic>>> getOrderConstraints() =>
      _db.collection(collectionOrderSettings).doc(documentOrderConstant)
      .snapshots();
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> getAllPurchaseByProducts(String pid) =>
      _db.collection(collectionPurchase)
      .where(purchaseProductId,isEqualTo: pid)
      .snapshots();

  static Stream<DocumentSnapshot<Map<String, dynamic>>> getProductsById(
          String id) =>
