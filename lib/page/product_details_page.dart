...
import 'package:ecomdmin/models/product_model.dart';
import 'package:ecomdmin/providers/product_provider.dart';
import 'package:ecomdmin/utils/constants.dart';
import 'package:ecomdmin/utils/helper_functions.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          stream: provider.getProductsById(pid),
 ...
 void _showPurchaseHistory(BuildContext context, ProductProvider provider) {
    showModalBottomSheet(
        ...
        builder: (context) => ListView.builder(
              itemCount: provider.purchaseListOfSpecifiProduct.length,
              itemBuilder: (context, index) {
                final purchase = provider.purchaseListOfSpecifiProduct[index];
                return ListTile(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    provider
                        .addNewPurchase(purchase, productModel.category!,productModel.stock)
                        .then((value) {
                      qController.clear();
